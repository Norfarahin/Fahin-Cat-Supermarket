...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `product` SET name = '$name', description = '$description', price = '$price', stock = '$stock' WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <textarea name="description" class="box" required placeholder="update product details" cols="30" rows="10"><?php echo $fetch_products['description']; ?></textarea>
   <input type="number" class="box"  value="<?php echo $fetch_products['stock']; ?>" placeholder="enter stock" name="stock">
